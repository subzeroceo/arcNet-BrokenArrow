...
============
*/
unsigned short idAASLocal::AreaTravelTime( int areaNum, const arcVec3 &start, const arcVec3 &end ) const {
	float dist;
	...
	return (unsigned short) arcMath::FtoiFast( dist );
}
...
============
*/
bool idAASLocal::SetAreaState_r( int nodeNum, const arcBounds &bounds, const int areaContents, bool disabled ) {
	int res;
...
============
*/
bool idAASLocal::SetAreaState( const arcBounds &bounds, const int areaContents, bool disabled ) {
	arcBounds expBounds;
...
============
*/
void idAASLocal::GetBoundsAreas_r( int nodeNum, const arcBounds &bounds, idList<int> &areas ) const {
	int res;
	const aasNode_t *node;
...
============
*/
aasHandle_t idAASLocal::AddObstacle( const arcBounds &bounds ) {
...
============
*/
ARC_INLINE int idAASLocal::ClusterAreaNum( int clusterNum, int areaNum ) const {
...
============
*/
bool idAASLocal::RouteToGoalArea( int areaNum, const arcVec3 origin, int goalAreaNum, int travelFlags, int &travelTime, idReachability **reach ) const {
...
============
*/
int idAASLocal::TravelTimeToGoalArea( int areaNum, const arcVec3 &origin, int goalAreaNum, int travelFlags ) const {
	int travelTime;
	idReachability *reach;
...
============
*/
bool idAASLocal::FindNearestGoal( aasGoal_t &goal, int areaNum, const arcVec3 origin, const arcVec3 &target, int travelFlags, float minDistance, float maxDistance, aasObstacle_t *obstacles, int numObstacles, idAASCallback &callback ) const {
