...
============
*/
rvAASFindGoalForHide::rvAASFindGoalForHide( const arcVec3 &hideFromPos ) {
	int			numPVSAreas;
	arcBounds	bounds( hideFromPos - arcVec3( 16, 16, 0 ), hideFromPos + arcVec3( 16, 16, 64 ) );
...
bool rvAASFindGoalForHide::TestArea( class idAAS *aas, int areaNum, const aasArea_t& area ) {
	...
	numPVSAreas = gameLocal.pvs.GetPVSAreas( arcBounds( area.center ).Expand( 16.0f ).TranslateSelf(arcVec3(0,0,1)), PVSAreas, idEntity::MAX_PVS_AREAS );
...
============
*/
bool rvAASFindGoalOutOfRange::TestPoint ( idAAS* aas, const arcVec3& pos, const float zAllow ) {
...
bool rvAASFindGoalForAttack::TestArea( class idAAS *aas, int areaNum, const aasArea_t& area ) {
	...
	// Out of pvs?
	numPVSAreas = gameLocal.pvs.GetPVSAreas( arcBounds( area.center ).Expand( 16.0f ), PVSAreas, idEntity::MAX_PVS_AREAS );
...
============
*/
bool rvAASFindGoalForAttack::TestPoint ( class idAAS *aas, const arcVec3& point, const float zAllow ) {
	float dist;

	arcVec3 localPoint = point;
...
bool rvAASFindGoalForTether::TestArea( class idAAS *aas, int areaNum, const aasArea_t& area ) {
	...
	arcBounds tempBounds = area.bounds;
...
============
*/
bool rvAASFindGoalForTether::TestPoint ( class idAAS* aas, const arcVec3& point, const float zAllow ) {
	if ( !tether ) {
		return false;
	}
