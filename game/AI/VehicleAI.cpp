...
================
*/
const idEntity * rvVehicleAI::MoveCloserTo ( const arcVec3 & point, idEntity * current ) {
...
================
*/
const idEntity * rvVehicleAI::MoveAwayFrom ( const arcVec3 & point, idEntity * current ) {
	const idEntity * best	= NULL;
