...
============
*/
bool idAASLocal::EdgeSplitPoint( arcVec3 &split, int edgeNum, const idPlane &plane ) const {
...
============
*/
bool idAASLocal::FloorEdgeSplitPoint( arcVec3 &bestSplit, int areaNum, const idPlane &pathPlane, const idPlane &frontPlane, bool closest ) const {
...
============
*/
bool idAASLocal::WalkPathValid( int areaNum, const arcVec3 &origin, int goalAreaNum, const arcVec3 &goalOrigin, int travelFlags, arcVec3 &endPos, int &endAreaNum ) const {
...
============
*/
arcVec3 idAASLocal::SubSampleWalkPath( int areaNum, const arcVec3 &origin, const arcVec3 &start, const arcVec3 &end, int travelFlags, int &endAreaNum ) const {
	int i, numSamples, curAreaNum;
	arcVec3 dir, point, nextPoint, endPos;
...
============
*/
bool idAASLocal::WalkPathToGoal( aasPath_t &path, int areaNum, const arcVec3 &origin, int goalAreaNum, const arcVec3 &goalOrigin, int travelFlags ) const {
...
============
*/
bool idAASLocal::FlyPathValid( int areaNum, const arcVec3 &origin, int goalAreaNum, const arcVec3 &goalOrigin, int travelFlags, arcVec3 &endPos, int &endAreaNum ) const {
	aasTrace_t trace;
...
============
*/
arcVec3 idAASLocal::SubSampleFlyPath( int areaNum, const arcVec3 &origin, const arcVec3 &start, const arcVec3 &end, int travelFlags, int &endAreaNum ) const {
	int i, numSamples, curAreaNum;
	arcVec3 dir, point, nextPoint, endPos;
...
============
*/
bool idAASLocal::FlyPathToGoal( aasPath_t &path, int areaNum, const arcVec3 &origin, int goalAreaNum, const arcVec3 &goalOrigin, int travelFlags ) const {
	int i, travelTime, curAreaNum, lastAreas[4], lastAreaIndex, endAreaNum;
	idReachability *reach = NULL;
	arcVec3 endPos;
...
============
*/
int idAASLocal::GetWallEdges( int areaNum, const arcBounds &bounds, int travelFlags, int *edges, int maxEdges ) const {
