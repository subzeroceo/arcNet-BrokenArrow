...
private:
	...
	bool			RotateEntityToAxial( idEntity *ent, arcVec3 rotationPoint );
#ifdef NEW_PUSH
	...
	bool			ClipTranslationAgainstPusher( trace_t &results, idEntity *ent, idEntity *pusher, const arcVec3 &translation );
	...
	void			ClipEntityTranslation( trace_t &trace, const idEntity *ent, const idClipModel *clipModel,
										idClipModel *skip, const arcVec3 &translation );
