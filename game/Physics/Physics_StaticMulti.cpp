...
================
*/
arcVec3 idPhysics_StaticMulti::GetCenterMass ( int id ) const {
	return GetOrigin();
}
// RAVEN END
...
================
*/
const arcBounds &idPhysics_StaticMulti::GetBounds( int id ) const {
	int i;
	static arcBounds bounds;
...
================
*/
const arcBounds &idPhysics_StaticMulti::GetAbsBounds( int id ) const {
	int i;
...
================
*/
void idPhysics_StaticMulti::GetImpactInfo( const int id, const arcVec3 &point, impactInfo_t *info ) const {
...
================
*/
void idPhysics_StaticMulti::ApplyImpulse( const int id, const arcVec3 &point, const arcVec3 &impulse ) {
}
...
================
*/
void idPhysics_StaticMulti::AddForce( const int id, const arcVec3 &point, const arcVec3 &force ) {
}
...
================
*/
void idPhysics_StaticMulti::SetOrigin( const arcVec3 &newOrigin, int id ) {
	arcVec3 masterOrigin;
	arcMat3 masterAxis;
...
================
*/
void idPhysics_StaticMulti::SetAxis( const arcMat3 &newAxis, int id ) {
	arcVec3 masterOrigin;
	arcMat3 masterAxis;
...
================
*/
void idPhysics_StaticMulti::Translate( const arcVec3 &translation, int id ) {
	int i;
...
================
*/
const arcVec3 &idPhysics_StaticMulti::GetOrigin( int id ) const {
	if ( id >= 0 && id < clipModels.Num() ) {
...
================
*/
const arcMat3 &idPhysics_StaticMulti::GetAxis( int id ) const {
	if ( id >= 0 && id < clipModels.Num() ) {
...
================
*/
void idPhysics_StaticMulti::SetLinearVelocity( const arcVec3 &newLinearVelocity, int id ) {
}
...
================
*/
void idPhysics_StaticMulti::SetAngularVelocity( const arcVec3 &newAngularVelocity, int id ) {
}
...
================
*/
const arcVec3 &idPhysics_StaticMulti::GetLinearVelocity( int id ) const {
	return vec3_origin;
}
...
================
*/
const arcVec3 &idPhysics_StaticMulti::GetAngularVelocity( int id ) const {
	return vec3_origin;
}
...
================
*/
void idPhysics_StaticMulti::SetGravity( const arcVec3 &newGravity ) {
}
...
================
*/
const arcVec3 &idPhysics_StaticMulti::GetGravity( void ) const {
	static arcVec3 gravity( 0, 0, -g_gravity.GetFloat() );
	if( gameLocal.isMultiplayer ) {
		gravity = arcVec3( 0, 0, -g_mp_gravity.GetFloat() );
	}
...
================
*/
const arcVec3 &idPhysics_StaticMulti::GetGravityNormal( void ) const {
	static arcVec3 gravity( 0, 0, -1 );
	return gravity;
}
...
================
*/
void idPhysics_StaticMulti::ClipTranslation( trace_t &results, const arcVec3 &translation, const idClipModel *model ) const {
...
================
*/
const arcVec3 &idPhysics_StaticMulti::GetPushedLinearVelocity( const int id ) const {
	return vec3_origin;
}
...
================
*/
const arcVec3 &idPhysics_StaticMulti::GetPushedAngularVelocity( const int id ) const {
	return vec3_origin;
}
