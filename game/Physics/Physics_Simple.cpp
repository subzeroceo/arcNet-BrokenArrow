...
=====================
*/
void sdSimplePhysicsNetworkData::Write( anFile* file ) const {
...
=====================
*/
void sdSimplePhysicsNetworkData::Read( anFile* file ) {
...
=====================
*/
void sdSimplePhysicsBroadcastData::Write( anFile* file ) const {
...
=====================
*/
void sdSimplePhysicsBroadcastData::Read( anFile* file ) {
...
void sdPhysics_Simple::SetClipModel( anClipModel *model, const float density, int id, bool freeOld ) {
	int minIndex;
	anMat3 inertiaScale;
...
================
*/
void sdPhysics_Simple::SetOrigin( const anVec3 &newOrigin, int id ) {
	anVec3 masterOrigin;
	anMat3 masterAxis;
...
================
*/
const anVec3 &sdPhysics_Simple::GetOrigin( int id ) const {
...
================
*/
void sdPhysics_Simple::SetAxis( const anMat3 &newAxis, int id ) {
...
================
*/
const anMat3 &sdPhysics_Simple::GetAxis( int id ) const {
	return current.axis;
}
...
================
*/
void sdPhysics_Simple::SetLinearVelocity( const anVec3 &newLinearVelocity, int id ) {
...
================
*/
const anVec3 &sdPhysics_Simple::GetLinearVelocity( int id ) const {
...
================
*/
void sdPhysics_Simple::SetAngularVelocity( const anVec3 &newAngularVelocity, int id ) {
...
================
*/
const anVec3 &sdPhysics_Simple::GetAngularVelocity( int id ) const {
...
================
*/
const anVec3 &sdPhysics_Simple::GetPushedLinearVelocity( const int id ) const {
...
================
*/
void sdPhysics_Simple::SetMaster( anEntity *master, const bool orientated ) {
	return;
}
...
================
*/
void sdPhysics_Simple::GetImpactInfo( const int id, const anVec3 &point, impactInfo_t *info ) const {
...
================
*/
void sdPhysics_Simple::ApplyImpulse( const int id, const anVec3 &point, const anVec3 &impulse ) {
	if ( locked ) {
		return;
	}
	...
	if ( rotates ) {
		anVec3 angularImpulse = ( point - ( current.origin + centerOfMass * current.axis ) ).Cross( impulse );
		anMat3 inverseWorldInertiaTensor = current.axis.Transpose() * inverseInertiaTensor * current.axis;
...
================
*/
void sdPhysics_Simple::Translate( const anVec3 &translation, int id ) {
...
================
*/
void sdPhysics_Simple::SetGroundPosition( const anVec3 &position ) {
...
const int	SIMPLE_ORIGIN_EXPONENT_BITS	= anMath::BitsForInteger( anMath::BitsForFloat( SIMPLE_ORIGIN_MAX ) ) + 1;
...
const int	SIMPLE_VELOCITY_EXPONENT_BITS	= anMath::BitsForInteger( anMath::BitsForFloat( SIMPLE_VELOCITY_MAX ) ) + 1;
