...
public:
	virtual anTransport*					GetParent( void ) const = 0;
...
public:
	...
	virtual	bool							Init( sdVehicleSuspensionInterface* object, const anDict& info ) = 0;
...
public:
	...
	virtual	bool							Init( sdVehicleSuspensionInterface* object, const anDict& info );
...
protected:
	sdVehicleSuspensionInterface*			_object;
	anMat3									_upperSuspensionAxes;
	jointHandle_t							_upperSuspensionJoint;
	anMat3									_lowerSuspensionAxes;
...
protected:
	...
	anMat3									_upperLegToHipJoint;

	float									_lowerLegLength;
	anMat3									_lowerLegToKneeJoint;
