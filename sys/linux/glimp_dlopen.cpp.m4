...
define(`forloop', `pushdef(`$1', `$2')
_forloop(`$1', `$2', `$3', `$4')popdef(`$1')')
define(`_forloop', `$4`'ifelse($1, `$3', , `define(`$1', incr($1 ) )
_forloop(`$1', `$2', `$3', `$4')')')
...
define(`assign_funcptr', `qgl`$1' = dll`$1';') forloop(`i', gl_start, gl_end, `assign_funcptr(indir(`f'i`_name') )')
