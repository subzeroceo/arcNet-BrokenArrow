...
ARC_INLINE const char* rvDebuggerScript::GetFilename	( void )
{
	return mFilename;
}

ARC_INLINE const char* rvDebuggerScript::GetContents	( void )
{
	return mContents?mContents:"";
}

ARC_INLINE idProgram& rvDebuggerScript::GetProgram ( void )
{
	return *mProgram;
}
