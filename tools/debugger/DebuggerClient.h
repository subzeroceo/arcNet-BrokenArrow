...
================
*/
ARC_INLINE bool rvDebuggerClient::IsConnected ( void )
{
	return mConnected;
}
...
================
*/
ARC_INLINE bool rvDebuggerClient::IsStopped ( void )
{
	return mBreak;
}
...
================
*/
ARC_INLINE int rvDebuggerClient::GetActiveBreakpointID ( void )
{
	return mBreakID;
}
...
================
*/
ARC_INLINE const char* rvDebuggerClient::GetBreakFilename ( void )
{
...
================
*/
ARC_INLINE int rvDebuggerClient::GetBreakLineNumber ( void )
{
...
================
*/
ARC_INLINE rvDebuggerCallstackList& rvDebuggerClient::GetCallstack ( void )
{
	return mCallstack;
}
...
================
*/
ARC_INLINE rvDebuggerThreadList& rvDebuggerClient::GetThreads ( void )
{
	return mThreads;
}
...
================
*/
ARC_INLINE const char* rvDebuggerClient::GetVariableValue ( const char* var, int stackDepth )
{
...
================
*/
ARC_INLINE rvDebuggerBreakpoint* rvDebuggerClient::GetBreakpoint ( int index )
{
...
================
*/
ARC_INLINE void rvDebuggerClient::Break ( void )
{
...
================
*/
ARC_INLINE void rvDebuggerClient::Resume ( void )
{
	mBreak = false;
...
================
*/
ARC_INLINE void rvDebuggerClient::StepOver ( void )
{
	mBreak = false;
...
================
*/
ARC_INLINE void rvDebuggerClient::StepInto ( void )
{
	mBreak = false;
...
================
*/
ARC_INLINE void rvDebuggerClient::SendPacket ( void* data, int size )
{
