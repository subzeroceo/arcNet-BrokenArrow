...
ARC_INLINE const char* rvDebuggerBreakpoint::GetFilename ( void )
{
	return mFilename;
}

ARC_INLINE int rvDebuggerBreakpoint::GetLineNumber ( void )
{
	return mLineNumber;
}

ARC_INLINE int rvDebuggerBreakpoint::GetID ( void )
{
	return mID;
}
