...
ARC_INLINE void rvRegistryOptions::SetLong ( const char* name, long v )
{
	mValues.SetInt ( name, v );
}

ARC_INLINE void rvRegistryOptions::SetBool ( const char* name, bool v )
{
	mValues.SetBool ( name, v );
}

ARC_INLINE void rvRegistryOptions::SetString ( const char* name, const char* v )
{
	mValues.Set ( name, v );
}
...
ARC_INLINE float rvRegistryOptions::GetFloat ( const char* name )
{
	return mValues.GetFloat ( name );
}

ARC_INLINE long rvRegistryOptions::GetLong ( const char* name )
{
	return mValues.GetInt ( name );
}

ARC_INLINE bool rvRegistryOptions::GetBool ( const char* name )
{
	return mValues.GetBool ( name );
}

ARC_INLINE const char* rvRegistryOptions::GetString ( const char* name )
{
