...
private:
	...
	int						BrushSplitterStats( const idBrush *brush, int planeNum, const aRcPlaneSet &planeList, bool *testedPlanes, struct splitterStats_s &stats );
	int						FindSplitter( idBrushBSPNode *node, const aRcPlaneSet &planeList, bool *testedPlanes, struct splitterStats_s &bestStats );
