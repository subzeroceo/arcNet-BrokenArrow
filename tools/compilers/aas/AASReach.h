...
public:
	bool					Build( const anMapFile *mapFile, anSEASFileLocal *file );

private:
	const anMapFile *		mapFile;
...
private:	// reachability
	void					FlagReachableAreas( anSEASFileLocal *file );
	...
	void					AddReachabilityToArea( anReachability *reach, int areaNum );
