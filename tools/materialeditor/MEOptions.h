...
ARC_INLINE void MEOptions::SetWindowPlacement ( const char* name, HWND hwnd ) {
	registry.SetWindowPlacement ( name, hwnd );
}

ARC_INLINE bool MEOptions::GetWindowPlacement ( const char* name, HWND hwnd ) {
	return registry.GetWindowPlacement ( name, hwnd );
}

ARC_INLINE void MEOptions::SetMaterialTreeWidth( int width) {
	materialTreeWidth = width;
	SetModified(true);
}

ARC_INLINE int MEOptions::GetMaterialTreeWidth() {
	return materialTreeWidth;
}

ARC_INLINE void MEOptions::SetStageWidth( int width) {
	stageWidth = width;
	SetModified(true);
}

ARC_INLINE int MEOptions::GetStageWidth() {
	return stageWidth;
}

ARC_INLINE void MEOptions::SetPreviewPropertiesWidth( int width) {
	previewPropertiesWidth = width;
	SetModified(true);
}

ARC_INLINE int MEOptions::GetPreviewPropertiesWidth() {
	return previewPropertiesWidth;
}

ARC_INLINE void MEOptions::SetMaterialEditHeight( int height) {
	materialEditHeight = height;
	SetModified(true);
}

ARC_INLINE int MEOptions::GetMaterialEditHeight() {
	return materialEditHeight;
}

ARC_INLINE void MEOptions::SetMaterialPropHeadingWidth( int width) {
	materialPropHeadingWidth = width;
	SetModified(true);
}

ARC_INLINE int MEOptions::GetMaterialPropHeadingWidth() {
	return materialPropHeadingWidth;
}

ARC_INLINE void MEOptions::SetPreviewPropHeadingWidth( int width) {
	previewPropHeadingWidth = width;
	SetModified(true);
}

ARC_INLINE int MEOptions::GetPreviewPropHeadingWidth() {
