...
void CMainFrame::OnPopupNewcameraInterpolated() {
	g_qeglobals.d_select_mode = sel_addpoint;
	g_qeglobals.selectObject = g_splineList->startNewCamera(ARCCameraPos::INTERPOLATED);
	OnSplinesEdit();
}
...
void CMainFrame::OnPopupNewcameraSpline() {
	g_qeglobals.d_select_mode = sel_addpoint;
	g_qeglobals.selectObject = g_splineList->startNewCamera(ARCCameraPos::SPLINE);
	OnSplinesEdit();
}
...
void CMainFrame::OnPopupNewcameraFixed() {
	g_qeglobals.d_select_mode = sel_addpoint;
	g_qeglobals.selectObject = g_splineList->startNewCamera(ARCCameraPos::FIXED);
	OnSplinesEdit();
}
