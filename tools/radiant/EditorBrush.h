...
void		Brush_Move (brush_t *b, const arcVec3 move, bool bSnap = true, bool updateOrigin = true);
...
brush_t *	Brush_Parse (const arcVec3 origin);
face_t *	Brush_Ray (arcVec3 origin, arcVec3 dir, brush_t *b, float *dist, bool testPrimitive = false);
...
void		Brush_Rotate(brush_t *b, arcVec3 vAngle, arcVec3 vOrigin, bool bBuild = true);
...
arcWinding *	Brush_MakeFaceWinding (brush_t *b, face_t *face, bool keepOnPlaneWinding = false);
...
void		Brush_RebuildBrush(brush_t *b, arcVec3 vMins, arcVec3 vMaxs, bool patch = true);
