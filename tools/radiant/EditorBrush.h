...
void		Brush_Move (brush_t *b, const anVec3 move, bool bSnap = true, bool updateOrigin = true);
...
brush_t *	Brush_Parse (const anVec3 origin);
face_t *	Brush_Ray (anVec3 origin, anVec3 dir, brush_t *b, float *dist, bool testPrimitive = false);
...
void		Brush_Rotate(brush_t *b, anVec3 vAngle, anVec3 vOrigin, bool bBuild = true);
...
anWinding *	Brush_MakeFaceWinding (brush_t *b, face_t *face, bool keepOnPlaneWinding = false);
...
void		Brush_RebuildBrush(brush_t *b, anVec3 vMins, anVec3 vMaxs, bool patch = true);
