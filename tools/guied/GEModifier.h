...
ARC_INLINE idWindow* rvGEModifier::GetWindow ( void )
{
	return mWindow;
}

ARC_INLINE const char* rvGEModifier::GetName ( void )
{
	return mName;
}

ARC_INLINE bool rvGEModifier::CanMerge ( rvGEModifier* merge )
{
	return false;
}

ARC_INLINE bool rvGEModifier::Merge ( rvGEModifier* merge )
{
	return false;
}
