...
ARC_INLINE bool rvGEApp::IsActive ( void )
{
	return mMDIFrame ? true : false;
}

ARC_INLINE rvGENavigator& rvGEApp::GetNavigator ( void )
{
	return mNavigator;
}

ARC_INLINE rvGEProperties& rvGEApp::GetProperties ( void )
{
	return mProperties;
}

ARC_INLINE rvGETransformer& rvGEApp::GetTransformer ( void )
{
	return mTransformer;
}

ARC_INLINE rvGEOptions& rvGEApp::GetOptions ( void )
{
	return mOptions;
}

ARC_INLINE HINSTANCE rvGEApp::GetInstance ( void )
{
	return mInstance;
}

ARC_INLINE rvGEStatusBar& rvGEApp::GetStatusBar ( void )
{
	return mStatusBar;
}

ARC_INLINE HWND rvGEApp::GetMDIFrame ( void )
{
	return mMDIFrame;
}

ARC_INLINE HWND rvGEApp::GetMDIClient ( void )
{
	return mMDIClient;
}
