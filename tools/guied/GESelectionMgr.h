...
ARC_INLINE void rvGESelectionMgr::SetWorkspace ( rvGEWorkspace* workspace )
{
...
ARC_INLINE bool rvGESelectionMgr::IsSelected ( idWindow* window )
{
	return mSelections.FindIndex ( window ) != -1 ? true : false;
}

ARC_INLINE bool rvGESelectionMgr::IsExpression ( void )
{
	return mExpression;
}
