...
void CDialogPDAEditor::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_BUTTON_SAVE_PDA, saveButton);
	//#modified-fva; END
	//}}AFX_DATA_MAP
}
...
BEGIN_MESSAGE_MAP(CDialogPDAEditor, CDialog)
	...
	ON_BN_CLICKED(IDC_BUTTON_SAVE_PDA, OnBtnClickedSave)
	//#modified-fva; END
...
public:
	...
	void OnOK() { GetDlgItemText(IDC_EDIT1_PDA, name); CDialog::OnOK(); }
	//#modified-fva; END
};
