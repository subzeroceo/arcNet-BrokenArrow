...
#pragma pack( pop )
//ARC_STATIC_ASSERT( sizeof( binaryImage_t ) == (sizeof( bimageImage_t ) + sizeof( bimageFile_t ) ) );
...
public:public:
	...
	anImage *			ImageFromFile( const char *name, textureFilter_t filter, bool allowDownSize,
