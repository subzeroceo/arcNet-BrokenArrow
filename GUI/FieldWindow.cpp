...
idFieldWindow::idFieldWindow(idDeviceContext *d, anUserInterface *g) : idWindow(d, g) {
	dc = d;
	gui = g;
	CommonInit();
}

idFieldWindow::idFieldWindow(anUserInterface *g) : idWindow(g) {
	gui = g;
	CommonInit();
}
...
void idFieldWindow::CalcPaintOffset( intlen) {
...
void idFieldWindow::Draw( inttime, float x, float y) {
