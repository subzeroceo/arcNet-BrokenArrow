...
=========================
*/
void Script_SetFocus(idWindow *window, anList<idGSWinVar> *src) {
...
=========================
*/
void Script_ShowCursor(idWindow *window, anList<idGSWinVar> *src) {
	idWinStr *parm = dynamic_cast<idWinStr*>((*src)[0].var);
	if ( parm ) {
		if ( atoi( *parm ) ) {
...
=========================
*/
void Script_LocalSound(idWindow *window, anList<idGSWinVar> *src) {
	idWinStr *parm = dynamic_cast<idWinStr*>((*src)[0].var);
	if (parm) {
...
=========================
*/
void Script_EvalRegs(idWindow *window, anList<idGSWinVar> *src) {
...
=========================
*/
void Script_EndGame( idWindow *window, anList<idGSWinVar> *src ) {
...
=========================
*/
void Script_ResetTime(idWindow *window, anList<idGSWinVar> *src) {
	idWinStr *parm = dynamic_cast<idWinStr*>((*src)[0].var);
...
=========================
*/
void Script_ResetCinematics(idWindow *window, anList<idGSWinVar> *src) {
...
=========================
*/
void Script_Transition(idWindow *window, anList<idGSWinVar> *src) {
...
=========================
*/
void idGuiScript::WriteToSaveGame( anFile *savefile ) {
	if ( ifList ) {
...
=========================
*/
void idGuiScript::ReadFromSaveGame( anFile *savefile ) {
	if ( ifList ) {
...
=========================
*/
bool idGuiScript::Parse(anParser *src) {
	...
	if (handler == &Script_Set) {
		...
		for ( int i = 1; i < parmCount; i++ ) {
			...
			if (anStr::Icmpn(*str, "gui::", 5) == 0) {
				...
				// Search for "play <...>"
				anToken token;
				anParser parser( LEXFL_NOSTRINGCONCAT | LEXFL_ALLOWMULTICHARLITERALS | LEXFL_ALLOWBACKSLASHSTRINGCONCAT );
...
=========================
*/
void idGuiScriptList::WriteToSaveGame( anFile *savefile ) {
...
=========================
*/
void idGuiScriptList::ReadFromSaveGame( anFile *savefile ) {
	for ( int i = 0; i < list.Num(); i++ ) {
