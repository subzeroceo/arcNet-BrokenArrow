...
idChoiceWindow::idChoiceWindow(idDeviceContext *d, anUserInterface *g) : idWindow(d, g) {
	dc = d;
	gui = g;
	CommonInit();
}

idChoiceWindow::idChoiceWindow(anUserInterface *g) : idWindow(g) {
	gui = g;
	CommonInit();
}
...
void idChoiceWindow::Draw( inttime, float x, float y) {
