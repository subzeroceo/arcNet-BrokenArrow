...
========================
*/
void anGLMatrix::DepthBoundsForExtrudedBounds( float & min, float & max, const anGLMatrix & mvp, const anBounds & bounds, const anVec3 & extrudeDirection, const idPlane & clipPlane, bool windowSpace ) {
