...
public:
	...
	virtual anDrawVertex	*AllocTris( int numVerts, const triIndex_t * indexes, int numIndexes, const anMaterial * material, const stereoDepthType_t stereoType = STEREO_DEPTH_TYPE_NONE ) = 0;
