...
================
*/
void arcCollisionModelManagerLocal::WriteNodes( anFile *fp, cm_node_t *node ) {
...
================
*/
void arcCollisionModelManagerLocal::WritePolygons( anFile *fp, cm_node_t *node ) {
	cm_polygonRef_t *pref;
	cm_polygon_t *p;
	int i;
...
================
*/
void arcCollisionModelManagerLocal::WriteBrushes( anFile *fp, cm_node_t *node ) {
	cm_brushRef_t *bref;
	cm_brush_t *b;
	int i;
...
================
*/
void arcCollisionModelManagerLocal::WriteCollisionModel( anFile *fp, cm_model_t *model ) {
...
================
*/
void arcCollisionModelManagerLocal::ParseVertices( anLexer *src, cm_model_t *model ) {
...
================
*/
void arcCollisionModelManagerLocal::ParseEdges( anLexer *src, cm_model_t *model ) {
	int i;
...
================
*/
cm_node_t *arcCollisionModelManagerLocal::ParseNodes( anLexer *src, cm_model_t *model, cm_node_t *parent ) {
	cm_node_t *node;
...
================
*/
void arcCollisionModelManagerLocal::ParsePolygons( anLexer *src, cm_model_t *model ) {
	cm_polygon_t *p;
	int i, numEdges;
	anVec3 normal;
	arcNetToken token;
...
================
*/
void arcCollisionModelManagerLocal::ParseBrushes( anLexer *src, cm_model_t *model ) {
	cm_brush_t *b;
	int i, numPlanes;
	anVec3 normal;
	arcNetToken token;
...
================
*/
bool arcCollisionModelManagerLocal::ParseCollisionModel( anLexer *src ) {
	cm_model_t *model;
	arcNetToken token;
