...
public:
	...
	void			Rotation( trace_t *results, const anVec3 &start, const arcRotation &rotation,
								const anTraceModel *trm, const anMat3 &trmAxis, int contentMask,
								cmHandle_t model, const anVec3 &modelOrigin, const anMat3 &modelAxis );
...
private:			// CollisionMap_load.cpp
	...
	int				R_ChoppedAwayByProcBSP( int nodeNum, arcFixedWinding *w, const anVec3 &normal, const anVec3 &origin, const float radius );
	int				ChoppedAwayByProcBSP( const arcFixedWinding &w, const anPlane &plane, int contents );
	...
	arcFixedWinding *WindingOutsideBrushes( arcFixedWinding *w, const anPlane &plane, int contents, int patch, cm_node_t *headNode );
	...
	void			CreatePolygon( cm_model_t *model, arcFixedWinding *w, const anPlane &plane, const anMaterial *material, int primitiveNum );
	void			PolygonFromWinding( cm_model_t *model, arcFixedWinding *w, const anPlane &plane, const anMaterial *material, int primitiveNum );
