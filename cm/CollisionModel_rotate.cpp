...
================
*/
int arcCollisionModelManagerLocal::CollisionBetweenEdgeBounds( cm_traceWork_t *tw, const anVec3 &va, const anVec3 &vb,
...
================
*/
int arcCollisionModelManagerLocal::RotateEdgeThroughEdge( cm_traceWork_t *tw, const anPluecker &pl1,
...
================
*/
int arcCollisionModelManagerLocal::EdgeFurthestFromEdge( cm_traceWork_t *tw, const anPluecker &pl1,
												const anVec3 &vc, const anVec3 &vd,
...
================
*/
int arcCollisionModelManagerLocal::RotatePointThroughPlane( const cm_traceWork_t *tw, const anVec3 &point, const anPlane &plane,
...
================
*/
int arcCollisionModelManagerLocal::PointFurthestFromPlane( const cm_traceWork_t *tw, const anVec3 &point, const anPlane &plane,
...
================
*/
int arcCollisionModelManagerLocal::RotatePointThroughEpsilonPlane( const cm_traceWork_t *tw, const anVec3 &point, const anVec3 &endPoint,
...
================
*/
void arcCollisionModelManagerLocal::RotateVertexThroughTrmPolygon( cm_traceWork_t *tw, cm_trmPolygon_t *trmpoly, cm_polygon_t *poly, cm_vertex_t *v, anVec3 &rotationOrigin ) {
	int i, edgeNum;
	float tanHalfAngle;
...
================
*/
void arcCollisionModelManagerLocal::BoundsForRotation( const anVec3 &origin, const anVec3 &axis, const anVec3 &start, const anVec3 &end, anBounds &bounds ) {
	int i;
	float radiusSqr;
	anVec3 v1, v2;
...
================
*/
void arcCollisionModelManagerLocal::Rotation180( trace_t *results, const anVec3 &rorg, const anVec3 &axis,
...
void arcCollisionModelManagerLocal::Rotation( trace_t *results, const anVec3 &start, const arcRotation &rotation,
										const anTraceModel *trm, const anMat3 &trmAxis, int contentMask,
										cmHandle_t model, const anVec3 &modelOrigin, const anMat3 &modelAxis ) {
	anVec3 tmp;
