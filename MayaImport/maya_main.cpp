...
/*
====================
arcTokenizer::SetTokens
====================
*/
int arcTokenizer::SetTokens( const char *buffer ) {
	const char *cmd;
...
/*
====================
arcTokenizer::NextToken
====================
*/
const char *arcTokenizer::NextToken( const char *errorstring ) {
...
/*
====================
arcExportOptions::Reset
====================
*/
void arcExportOptions::Reset( const char *commandline ) {
	scale			= 1.0f;
	type			= WRITE_MESH;
	startframe		= -1;
	endframe		= -1;
...
/*
====================
arcExportOptions::arcExportOptions
====================
*/
arcExportOptions::arcExportOptions( const char *commandline, const char *ospath ) {
	...
	for ( token = tokens.NextToken(); token != ""; token = tokens.NextToken() ) {
		if ( token == "-force" ) {
			...
			// parse game name
			game = tokens.NextToken( "Expecting engine name after -engine" );
...
/*
====================
arcExportOptions::jointInExportGroup
====================
*/
bool arcExportOptions::jointInExportGroup( const char *jointname ) {
	arcAnimGroup	*group;
	...
	for ( int i = 0; i < exportgroups.Num(); i++ ) {
		group = exportgroups[ i ];
		for ( int j = 0; j < group->joints.Num(); j++ ) {
...
arcExportJoint &arcExportJoint::operator=( const arcExportJoint &other ) {
	name		= other.name;
...
void arcExportMesh::Merge( arcExportMesh *mesh ) {
	int i;
	int numverts;
	int numtris;
	int numweights;
...
/*
====================
arcExportModel::arcExportModel
====================
*/
ARC_INLINE arcExportModel::arcExportModel() {
	export_joints		= 0;
	skipjoints			= 0;
	frameRate			= 24;
	numFrames			= 0;
...
arcExportJoint *arcExportModel::FindJointReal( const char *name ) {
...
arcExportJoint *arcExportModel::FindJoint( const char *name ) {
	arcExportJoint	*joint = joints.Ptr();
...
bool arcExportModel::WriteMesh( const char *filename, arcExportOptions &options ) {
	int				i, j;
	int				numMeshes;
	arcExportMesh	*mesh;
	arcExportJoint	*parent;
	arcExportJoint	*sibling;
...
bool arcExportModel::WriteAnim( const char *filename, arcExportOptions &options ) {
	int				i, j;
	arcExportJoint	*joint;
	arcExportJoint	*parent;
	arcExportJoint	*sibling;
...
bool arcExportModel::WriteCamera( const char *filename, arcExportOptions &options ) {
	int		i;
	FILE	*file;
...
/*
===============
arcMayaExport::TimeForFrame
===============
*/
float arcMayaExport::TimeForFrame( int num ) const {
	MTime	time;
...
/*
===============
arcMayaExport::GetMayaFrameNum
===============
*/
int arcMayaExport::GetMayaFrameNum( int num ) const {
	int	frameNum;
...
/*
===============
arcMayaExport::SetFrame
===============
*/
void arcMayaExport::SetFrame( int num ) {
	MTime	time;
	int		frameNum;
...
/*
===============
arcMayaExport::FreeDagNodes
===============
*/
void arcMayaExport::FreeDagNodes( void ) {
	int i;
...
/*
===============
arcMayaExport::GetBindPose
===============
*/
void arcMayaExport::GetBindPose( MObject &jointNode, arcExportJoint *joint, float scale ) {
	MStatus				status;
...
/*
===============
arcMayaExport::CreateJoints
===============
*/
void arcMayaExport::CreateJoints( float scale ) {
	int				i;
	int				j;
	arcExportJoint	*joint;
	arcExportJoint	*parent;
...
/*
===============
arcMayaExport::FindShader

Find the shading node for the given shading group set node.
===============
*/
MObject arcMayaExport::FindShader( MObject& setNode ) {
	MStatus				status;
...
/*
===============
arcMayaExport::GetTextureForMesh
...
===============
*/
void arcMayaExport::GetTextureForMesh( arcExportMesh *mesh, MFnDagNode &dagNode ) {
	MStatus		status;
	MDagPath	path;
	int			i;
	int			instanceNum;
...
/*
===============
arcMayaExport::CopyMesh
===============
*/
arcExportMesh *arcMayaExport::CopyMesh( MFnSkinCluster &skinCluster, float scale ) {
	MStatus			status;
...
/*
===============
arcMayaExport::CreateMesh
===============
*/
void arcMayaExport::CreateMesh( float scale ) {
	size_t			count;
	arcExportMesh	*mesh;
	MStatus			status;
	exportWeight_t	weight;
...
/*
===============
arcMayaExport::CombineMeshes

combine surfaces with the same shader.
===============
*/
void arcMayaExport::CombineMeshes( void ) {
	int						i, j;
	int						count;
	arcExportMesh			*mesh;
...
/*
===============
arcMayaExport::GetObjectType

return the type of the object
===============
*/
const char *arcMayaExport::GetObjectType( MObject object ) {
	if ( object.isNull() ) {
		return "(Null)";
	}
...
/*
===============
arcMayaExport::GetCameraFov
===============
*/
float arcMayaExport::GetCameraFov( arcExportJoint *joint ) {
	int		childCount;
	int		j;
	double	horiz;
	double	focal;
...
/*
===============
arcMayaExport::ConvertToMD3
===============
*/
void arcMayaExport::ConvertToMD3( void ) {
#if 0
	int					i, j;
...
const char *Maya_ConvertModel( const char *ospath, const char *commandline ) {
	...
	try {
		arcExportOptions options( commandline, ospath );
		arcMayaExport	exportM( options );
