...
ARC_INLINE static const char *anJSonFormat::SkipStruct( const char *json, const char *jsonEnd ) {
...
ARC_INLINE static const char *anJSonFormat::SkipValue( const char *json, const char *jsonEnd ) {
	if ( json >= jsonEnd ) {
		return jsonEnd;
	} else if ( *json == '"' ) {
...
ARC_INLINE static const char *anJSonFormat::SkipValueAndSeparators( const char *json, const char *jsonEnd ) {
...
ARC_INLINE static unsigned int anJSonFormat::NoParse( const char *json, const char *jsonEnd ) {
...
ARC_INLINE const char *anJSonFormat::ArrayGetFirstValue( const char *json, const char *jsonEnd ) {
...
ARC_INLINE const char *anJSonFormat::ArrayGetNextValue( const char *json, const char *jsonEnd ) {
...
ARC_INLINE unsigned int anJSonFormat::ArrayGetIndex( const char *json, const char *jsonEnd, const char **indexes, unsigned int numIndexes ) {
...
ARC_INLINE const char *anJSonFormat::ArrayGetValue( const char *json, const char *jsonEnd, unsigned int index ) {
...
ARC_INLINE const char *anJSonFormat::ObjectGetNamedValue( const char *json, const char *jsonEnd, const char *name ) {
...
ARC_INLINE unsigned int anJSonFormat::ValueGetType( const char *json, const char *jsonEnd ) {
...
ARC_INLINE double anJSonFormat::ValueGetDouble( const char *json, const char *jsonEnd ) {
	char cValue[256];
	double dValue = 0.0;
...
ARC_INLINE float anJSonFormat::ValueGetFloat( const char *json, const char *jsonEnd ) {
	char cValue[256];
	float fValue = 0.0f;
	unsigned int np = NoParse( json, jsonEnd );
...
ARC_INLINE int anJSonFormat::ValueGetInt( const char *json, const char *jsonEnd ) {
	char cValue[256];
	int iValue = 0;
	unsigned int np = NoParse( json, jsonEnd );
