...
/*
========================
arcDataQueue::RemoveOlderThan
========================
*/
template< int maxItems, int maxBuffer >
void arcDataQueue< maxItems, maxBuffer >::RemoveOlderThan( int sequence ) {
	int length = 0;
...
*/
template< int maxItems, int maxBuffer >
bool arcDataQueue< maxItems, maxBuffer >::Append( int sequence, const byte * b1, int b1Len, const byte * b2, int b2Len ) {
