...
/*
========================
anDataQueue::RemoveOlderThan
========================
*/
template< int maxItems, int maxBuffer >
void anDataQueue< maxItems, maxBuffer >::RemoveOlderThan( int sequence ) {
	int length = 0;
...
*/
template< int maxItems, int maxBuffer >
bool anDataQueue< maxItems, maxBuffer >::Append( int sequence, const byte * b1, int b1Len, const byte * b2, int b2Len ) {
