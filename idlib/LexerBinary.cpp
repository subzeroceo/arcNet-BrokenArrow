...
============
*/
bool arcNetTokenCache::Write( arcNetFile *f ) {
...
============
*/
bool arcNetTokenCache::Read( arcNetFile* f ) {
	int numTokens;
	f->ReadInt( numTokens );
...
============
*/
bool arcNetBinaryLexer::Write( arcNetFile* f ) {
...
============
*/
bool arcNetBinaryLexer::Read( arcNetFile *f ) {
	isLoaded = false;
...
int arcNetBinaryLexer::ReadToken( arcNetToken *token ) {
	...
	const arcNetList<unsigned short>* localTokens = tokensData != NULL ? tokensData : &tokens;
