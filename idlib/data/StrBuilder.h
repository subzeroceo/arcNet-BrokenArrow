...
template<>
class sdStringBuilder_Traits< anStr > {
public:
	typedef char CharType;
	typedef anStr StrType;
...
typedef sdStringBuilder<anStr, sdCharAllocator_Heap< 512, char> > sdStringBuilder_Heap;
