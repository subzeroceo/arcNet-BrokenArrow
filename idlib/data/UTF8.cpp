...
template< typename T > inline bool Is1ByteUTF8SequenceStart( const T value ) { return ( ( value & 0x80 ) == 0x00 ); }
template< typename T > inline bool Is2ByteUTF8SequenceStart( const T value ) { return ( ( value & 0xE0 ) == 0xC0 ); }
template< typename T > inline bool Is3ByteUTF8SequenceStart( const T value ) { return ( ( value & 0xF0 ) == 0xE0 ); }
template< typename T > inline bool IsValidUTF8Sequence( const T value ) { return ( ( value & 0xC0 ) == 0x80 ); }
template< typename T > inline bool Is3ByteUTF8Sequence( const T value ) { return value > 0x7FF; }
template< typename T > inline bool Is2ByteUTF8Sequence( const T value ) { return value > 0x7F; }
