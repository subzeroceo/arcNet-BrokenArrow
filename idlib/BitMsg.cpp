...
==================
*/
bool anBitMessage::WriteDeltaDict( const arcDictionary &dict, const arcDictionary *base ) {
	int i;
...
==================
*/
bool anBitMessage::ReadDeltaDict( arcDictionary &dict, const arcDictionary *base ) const {
