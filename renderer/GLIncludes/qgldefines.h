...
DEF(GL_CURRENT_RASTER_TEXTURE_CO)
DEF(GL_CURRENT_RASTER_POSITION)
DEF(GL_CURRENT_RASTER_POSITION_V)
...
DEF(GL_STEREO)
DEF(GL_RENDER_MODE)
DEF(GL_PERSPECTIVE_CORRECTION_HI)
...
DEF(GL_MAX_PROJECTION_STACK_DEPT)
DEF(GL_MAX_TEXTURE_STACK_DEPTH)
DEF(GL_MAX_VIEWPORT_DIMS)
DEF(GL_MAX_CLIENT_ATTRIB_STACK_D)
...
// PixelStore
//DEF(GL_UNPACK_SWAP_BY)
//DEF(GL_UNPACK_LSB_FIR)
//DEF(GL_UNPACK_ROW_LEN)
//DEF(GL_UNPACK_SKIP_RO)
//DEF(GL_UNPACK_SKIP_PI)
//DEF(GL_UNPACK_ALIGNME)
//DEF(GL_PACK_SWAP_BYTE)
//DEF(GL_PACK_LSB_FIRST)
//DEF(GL_PACK_ROW_LENGT)
//DEF(GL_PACK_SKIP_ROWS)
//DEF(GL_PACK_SKIP_PIXE)
//DEF(GL_PACK_ALIGNMENT)
