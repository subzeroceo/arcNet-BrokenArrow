...
void R_R200_Init( void ) {
	qglConfig.allowR200Path = false;

	common->Printf( "----------- R200_Init -----------\n" );

	if ( !qglConfig.atiShaderFragmentOn || !qglConfig.ARBVertexProgramAvailable || !qglConfig.ARBVertexBufferObjectAvailable ) {
