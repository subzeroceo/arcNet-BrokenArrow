...
public:
	...
	//virtual void 			AddToProjectedDecal( const anFixedWinding& winding, const anVec3 &projectionOrigin, const bool parallel, const anVec4& color, anRenderModel* model, int entityNum, const anMaterial** onlyMaterials = nullptr, const int numOnlyMaterials = 1 ) = 0;
	//virtual void			ResetDecalModel( anRenderModel* model ) = 0;
	//virtual void			FinishDecal( anRenderModel* model ) = 0;
	...
	virtual void			ProjectDecalOntoWorld( const anFixedWinding &winding, const anVec3 &projectionOrigin, const bool parallel, const float fadeDepth, const anMaterial *material, const int startTime ) = 0;

	// Creates decals on static models.
	virtual void			ProjectDecal( arcNetHandle_t entityHandle, const anFixedWinding &winding, const anVec3 &projectionOrigin, const bool parallel, const float fadeDepth, const anMaterial *material, const int startTime ) = 0;
