...
static arcDynamicBlockAlloc<anDrawVertex, 1<<20, 1<<10>	triVertexAllocator;
static arcDynamicBlockAlloc<qglIndex_t, 1<<18, 1<<10>		triIndexAllocator;
static arcDynamicBlockAlloc<anShadowCache, 1<<18, 1<<10>	triShadowVertexAllocator;
static arcDynamicBlockAlloc<anPlane, 1<<17, 1<<10>		triPlaneAllocator;
...
#else
static arcDynamicAlloc<anDrawVertex, 1<<20, 1<<10>			triVertexAllocator;
static arcDynamicAlloc<qglIndex_t, 1<<18, 1<<10>			triIndexAllocator;
static arcDynamicAlloc<anShadowCache, 1<<18, 1<<10>		triShadowVertexAllocator;
static arcDynamicAlloc<anPlane, 1<<17, 1<<10>			triPlaneAllocator;
...
================
*/
void R_SurfaceToTextureAxis( const surfTriangles_t *tri, anVec3 &origin, anVec3 axis[3] ) {
	float		area, inva;
	float		d0[5], d1[5];
	anDrawVertex	*a, *b, *c;
	float		bounds[2][2];
